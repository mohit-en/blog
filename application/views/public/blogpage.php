                                                ...
                                                <div class="comments-list text-center text-md-left">
                                                    ...
                                                    <div class="row mb-5">
                                                        ...
                                                        <div class="col-sm-2 col-12 mb-3">
                                                            <img src="<?php echo base_url(); ?>tools/image/blogpage/img (8).jpg" class="avatar rounded-circle z-depth-1-half" alt="sample image">
                                                        </div>
                                                        <!--/.Image column-->
                                                    ...
                                                    <div class="row mb-5">
                                                        ...
                                                        <div class="col-sm-2 col-12">
                                                            <img src="<?php echo base_url(); ?>tools/image/blogpage/img (30).jpg" class="avatar rounded-circle z-depth-1-half" alt="sample image">
                                                        </div>
                                                        <!--/.Image column-->
                                                    ...
                                                    <div class="row mb-5">
                                                        <!--Image column-->
                                                        <div class="col-sm-2 col-12 mb-3">
                                                            <img src="<?php echo base_url(); ?>tools/image/blogpage/img (28)1.jpg" class="avatar rounded-circle z-depth-1-half" alt="sample image">
                                                        </div>
                                                        <!--/.Image column-->
                                                        <!--Content column-->
                                                        <div class="col-sm-10 col-12">
