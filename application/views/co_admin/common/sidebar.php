        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <a href="<?php echo base_url(); ?>co_admin/index" class="nav-link <?php echo $active_page == "dashboard" ? "active" : "" ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url(); ?>co_admin/calender" class="nav-link <?php echo $active_page == "calender" ? "active" : "" ?>">
