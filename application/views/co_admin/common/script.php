...
<!-- fullCalendar 2.2.5 -->
<script src="<?php echo base_url(); ?>tools/plugins/fullcalendar/main.js"></script>
<!-- Summernote -->
...
<!-- CodeMirror -->
<script src="<?php echo base_url(); ?>tools/plugins/codemirror/codemirror.js"></script>
<script src="<?php echo base_url(); ?>tools/plugins/codemirror/mode/css/css.js"></script>
<script src="<?php echo base_url(); ?>tools/plugins/codemirror/mode/xml/xml.js"></script>
<script src="<?php echo base_url(); ?>tools/plugins/codemirror/mode/htmlmixed/htmlmixed.js"></script>
<!-- for text editor scripts for page specific  -->
<script src="<?php echo base_url(); ?>tools/dist/js/pages/add_post.js"></script>
