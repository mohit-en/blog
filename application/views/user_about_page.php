...
<head>
    ...
    <!-- External css -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>tools/dist/css/user_about_page.css" />
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <p class="text-secondary mb-1"> <?php echo $data[0]['profession']; ?> </p>
                    ...
                    <div class="card mt-3">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary"><?php echo $data[0]['website'];?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                ...
                                <span class="text-secondary"><?php echo $data[0]['github'];?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                ...
                                <span class="text-secondary"><?php echo $data[0]['twitter'];?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                ...
                                <span class="text-secondary"><?php echo $data[0]['instagram'];?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                ...
                                <span class="text-secondary"><?php echo $data[0]['facebook'];?></span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary"><?php echo $data[0]['user_name']; ?></div>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"><?php echo $data[0]['email']; ?></div>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"><?php echo $data[0]['phone']; ?></div>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"><?php echo $data[0]['moblie']; ?></div>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"><?php echo $data[0]['address']; ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="row gutters-sm">
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <h6 class="d-flex align-items-center mb-3">
                                        <i class="material-icons text-info mr-2">Assignment</i>Articles Status
                                    </h6>
                                    <small>Web Design</small>
                                    <div class="progress mb-3" style="height: 5px">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: 91%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
